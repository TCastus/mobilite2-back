    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_type', models.CharField(choices=[('DD', 'Double Diplôme'), ('E', 'Echange'), ('X', 'Inconnu')], default='X', max_length=100, verbose_name='Type de mobilité')),
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mobi.city', verbose_name="Ville de l'université")),
                ('department_availability', models.ManyToManyField(to='mobi.DepartementINSA', verbose_name='Disponibilité selon le Département')),
                ('financial_aid', models.ManyToManyField(to='mobi.FinancialAid', verbose_name='Aides disponibles pour cette université')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('university', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mobi.university', verbose_name='Université concernée')),
            ],
        ),
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mobi.country', verbose_name='Nom du pays de la ville'),
        ),
    ]
